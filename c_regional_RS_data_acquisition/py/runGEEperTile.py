...
if 'polygon' in extent:
  ...
  if shapefile == True:
    ...
    with fiona.open('c_regional_RS_data_acquisition/run/user_polygon.shp') as src:
...
if 'polycenter' in extent:
  if yml['polygon'][0] == True:
    centers_csv = read_csv('c_regional_RS_data_acquisition/run/user_polygon_centers.csv')
